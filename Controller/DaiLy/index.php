<?php
$table = 'daily';
$sql = "select d.*,TenLoaiDL, l.TienNoToiDa, q.DeleteFlag, l.DeleteFlag, TenQuan from daily d, loaidaily l, quan q where d.MaLoaiDL = l.MaLoaiDL and q.MaQuan = d.MaQuan and d.DeleteFlag =0";
$table2 = "loaidaily";
...
if (isset($_POST['submit'])) {
    ...
    $sdt = $_POST['sdt'];
    $diaChi = $_POST['diaChi'];
    if (isset($_POST['ngayTN'])&&isset($_POST['loai'])) {
        $ngayTN = $_POST['ngayTN'];
        $loai = $_POST['loai'];
    }
    $quan = $_POST['quan'];
        ...
        $("#addForm").validate({
            ...
            messages: {
                ...
                diaChi: {
                    ...
                    address: "<span class='error'>Không được phép nhập ký tự đặc biệt!</span>"
                },
                loai: {
