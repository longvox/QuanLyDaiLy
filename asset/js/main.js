    ...
    this.leftMenu =  function()
    {
         ...
         $('.opener-left-menu').on('click', function(){
            ...
            if( $('#left-menu .sub-left-menu').is(':visible') ) {
                ...
                document.querySelector("#left-menu").setAttribute("closed","");
                ...
                document.querySelector("#left-menu").removeAttribute("closed");
